...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Ensure empty data is not stored on the database as opposed
        # to being stored as an empty string.
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                profile.default_phone_number=shipping_details.phone,  # noqa
                profile.default_country=shipping_details.address.country,  # noqa
                ...
                profile.default_county=shipping_details.address.state,  # noqa
                profile.save()
