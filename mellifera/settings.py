...
# SECURITY WARNING: don't mess with this setting: it
# ensures the deployed app is not in DEBUG mode!
...
# Stripe settings
STANDARD_DELIVERY_PERCENTAGE = 6
STRIPE_CURRENCY = 'eur'
...
DEFAULT_FROM_EMAIL = 'hylandjaime@gmail.com'
